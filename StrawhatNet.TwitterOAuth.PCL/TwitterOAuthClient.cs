    ...
    public class TwitterOAuthClient
    {
            ...
            HttpMessageHandler handler)
        {
            ...
            using (var client = new HttpClient(handler))
            {
                ...
                var content = new HttpStringContent(this.CreateRequestString(requestParams), UnicodeEncoding.Utf8, contentType);
                 */
        ...
        // geturl
        public string GetRedirectUserUrl(RequestTokenResponse requestToken)
        {
            string redirectUrl
        ...
        //
        //    string redirectUrl
        //        = String.Format("{0}?{1}={2}", AuthorizeUrl, OAuthTokenParameter, request_token);
        //    Uri StartUri = new Uri(redirectUrl);
        //    Uri EndUri = new Uri(OAuthCallbackUrl);
